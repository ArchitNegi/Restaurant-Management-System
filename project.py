...
lbl1 = Label(f1, text="Restaurant Management System", font='Times 30 bold', fg='saddle brown')
lbl1.grid(row=0, column=0)
current_time = time.asctime(time.localtime(time.time()))
lbl2 = Label(f1, text=current_time, font='Times 20 bold', fg='dim gray')
...
btn1=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="1",bg="gainsboro",command=lambda:btnclick(1))
btn1.grid(row=4,column=0)

btn2=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="2",bg="gainsboro",command=lambda:btnclick(2))
btn2.grid(row=4,column=1)

btn3=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="3",bg="gainsboro",command=lambda:btnclick(3))
btn3.grid(row=4,column=2)

btn4=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="4",bg="gainsboro",command=lambda:btnclick(4))
btn4.grid(row=3,column=0)

btn5=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="5",bg="gainsboro",command=lambda:btnclick(5))
btn5.grid(row=3,column=1)

btn6=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="6",bg="gainsboro",command=lambda:btnclick(6))
btn6.grid(row=3,column=2)

btn7=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="7",bg="gainsboro",command=lambda:btnclick(7))
btn7.grid(row=2,column=0)

btn8=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="8",bg="gainsboro",command=lambda:btnclick(8))
btn8.grid(row=2,column=1)

btn9=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="9",bg="gainsboro",command=lambda:btnclick(9))
btn9.grid(row=2,column=2)

btn0=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="0",bg="gainsboro",command=lambda:btnclick(0))
btn0.grid(row=5,column=0)

Add=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="+",bg="gainsboro",command=lambda:btnclick('+'))
Add.grid(row=2,column=3)

Sub=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="-",bg="gainsboro",command=lambda:btnclick('-'))
Sub.grid(row=3,column=3)

multiply=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="*",bg="gainsboro",command=lambda:btnclick('*'))
multiply.grid(row=4,column=3)

btnclear=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="c",bg="gainsboro",command=lambda:clear())
btnclear.grid(row=5,column=1)

Decimal=Button(f3,padx=16,pady=16,bd=4, font=('ariel', 20 ,'bold'),text=".",bg="gainsboro",command=lambda:btnclick('.'))
Decimal.grid(row=5,column=2)

Division=Button(f3,padx=16,pady=16,bd=4,font=('ariel', 20 ,'bold'),text="/",bg="gainsboro",command=lambda:btnclick('/'))
Division.grid(row=5,column=3)

btnequal=Button(f3,padx=16,pady=16,bd=4,width = 16,font=('ariel', 20 ,'bold'),text="=",bg="gainsboro",command=lambda:equals())
